...
class Report_Aged_Partner_Balance(models.AbstractModel):
    _name = 'report.fnet_omega_crm.report_budget'
    ...
    def render_html(self, docids, data=None):
        ...
        balance_report = Report._get_report_from_name('fnet_omega_crm.report_budget')
        ...
        return Report.render('fnet_omega_crm.report_budget', docargs)
