...
class ResConfigSettings(models.TransientModel):
    ...
    sale_cost_single_approval_rule_id = fields.Many2one('sale.cost.approval.rule', related='company_id.sale_cost_single_approval_rule_id', string='Sale Costing Approval Rules', readonly=False)
    sale_cost_double_approval_rule_id = fields.Many2one('sale.cost.approval.rule', related='company_id.sale_cost_double_approval_rule_id', string='Sale Costing Approval Rules', readonly=False)
    sale_cost_approval = fields.Boolean(related='company_id.sale_cost_approval', string='Sale Costing double Approval By Rule', readonly=False)
    sale_cost_double_approval = fields.Boolean(related='company_id.sale_cost_approval', string='Sale Costing Two Approval By Rule', readonly=False)
...
class SaleOrderApprovalRule(models.Model):
    ...
    is_single_hierarchy = fields.Boolean('Is single hierarchy')
