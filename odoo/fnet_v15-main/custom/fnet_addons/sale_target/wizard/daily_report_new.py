...
class DailyReport(models.TransientModel):
    ...
    def action_daily_report(self):
        ...
        sheet.write(4, 0, 'DESCRIPTION', sub_title_format)
        if previous_year_budget:
            ...
            sheet.merge_range(4, 5, 4, 6, self.date_to.strftime('%B %Y'), head_bold)
            sheet.write(5, 5, 'BUDGET', sub_title_format)
            sheet.write(5, 6, 'ACTUAL', sub_title_format)
            sheet.merge_range(4, 7, 4, 8, 'UPTO ' + self.date_to.strftime('%B %Y'), head_bold)
            sheet.write(5, 7, 'BUDGET', sub_title_format)
            sheet.write(5, 8, 'ACTUAL', sub_title_format)
        else:
        ...
        if previous_year_budget:
            ...
            sheet.write(6, 5, sales_total_budget_exist_current if sales_total_budget_exist_current != 0 else '-', parent_format)
            ...
            sheet.write(6, 6, sales_total_invoice_exist_current if sales_total_invoice_exist_current != 0 else '-',parent_format)
            ...
            sheet.write(6, 7, sales_total_budget_exist_current1 if sales_total_budget_exist_current1 != 0 else '-', parent_format)
            ...
            sheet.write(6, 8, sales_total_invoice_exist_current1 if sales_total_invoice_exist_current1 != 0 else '-',parent_format)
            row = 7
            ...
            for team_id in team_ids:
                ...
                for sale_type_id in sale_type_ids:
                    ...
                    for sub_type_id in sale_type_id.sales_sub_types:
                        ...
                        sheet.write(row, 5, sales_subtype_total_budget_exist_current if sales_subtype_total_budget_exist_current != 0 else '-', bold_2)
                        ...
                        sheet.write(row, 6, sales_subtype_total_invoice_exist_current if sales_subtype_total_invoice_exist_current != 0 else '-', bold_2)
                        ...
                        sheet.write(row, 7, sales_subtype_total_budget_exist_current1 if sales_subtype_total_budget_exist_current1 != 0 else '-', bold_2)
                        ...
                        sheet.write(row, 8, sales_subtype_total_invoice_exist_current1 if sales_subtype_total_invoice_exist_current1 != 0 else '-', bold_2)
                        row += 1
        ...
        # # Purchase functionality section
            ...
            sheet.write(row, 5, total_bill_budget_current if total_bill_budget_current != 0 else '-', parent_format)
            ...
            sheet.write(row, 6, total_bill_current if total_bill_current != 0 else '-', parent_format)
            ...
            sheet.write(row, 7, total_bill_budget_current1 if total_bill_budget_current1 != 0 else '-', parent_format)
            ...
            sheet.write(row, 8, total_bill_current1 if total_bill_current1 != 0 else '-', parent_format)
            row += 1
            for team_id in team_ids:
                sheet.write(row, 0, team_id.name, parent_name_format)
                ...
                sheet.write(row, 5, total_bill_sale_type_budget_current if total_bill_sale_type_budget_current != 0 else '-', sale_type_format)
                exist_no_bill_type_total_current = 0
                ...
                sheet.write(row, 6, total_bill_sale_type_current if total_bill_sale_type_current != 0 else '-', sale_type_format)
                ...
                sheet.write(row, 7,total_bill_sale_type_budget_current1 if total_bill_sale_type_budget_current1 != 0 else '-', sale_type_format)
                exist_no_bill_type_total_current1 = 0
                for sub_type_id in current_year_budget.sale_budget_lines.filtered(lambda x: x.team_id.id == team_id.id and x.is_no_bill != False).mapped('sale_sub_type_id'):
                ...
                sheet.write(row, 8, total_bill_sale_type_current1 if total_bill_sale_type_current1 != 0 else '-', sale_type_format)
                row += 1
                for sale_type_id in sale_type_ids:
                    sheet.set_row(row, None, None, {'level': 1, 'hidden': True})
                    sheet.write(row, 0, sale_type_id.name, sale_type_name_format)
                    ...
                    for sub_type_id in sale_type_id.sales_sub_types:
                        ...
                        sheet.write(row, 5, total_bill_sub_budget_current if total_bill_sub_budget_current != 0 else '-', bold_2)
                        ...
                        sheet.write(row, 6, total_bill_sub_current if total_bill_sub_current != 0 else '-', bold_2)
                        ...
                        sheet.write(row, 7, total_bill_sub_budget_current1 if total_bill_sub_budget_current1 != 0 else '-', bold_2)
                        ...
                        sheet.write(row, 8, total_bill_sub_current1 if total_bill_sub_current1 != 0 else '-', bold_2)
                        row += 1
        # Gross Margin functionalities start
            ...
            sheet.write(row, 5, gross_total_budget_current if gross_total_budget_current != 0 else '-', parent_format)
            gross_total_exist_current = sales_total_invoice_exist_current - total_bill_current
            sheet.write(row, 6, gross_total_exist_current if gross_total_exist_current != 0 else '-', parent_format)
            gross_total_budget_current1 = sales_total_budget_exist_current1 - total_bill_budget_current1
            sheet.write(row, 7, gross_total_budget_current1 if gross_total_budget_current1 != 0 else '-', parent_format)
            gross_total_exist_current1 = sales_total_invoice_exist_current1 - total_bill_current1
            sheet.write(row, 8, gross_total_exist_current1 if gross_total_exist_current1 != 0 else '-', parent_format)
            row += 1
            for team_id in team_ids:
                sheet.write(row, 0, team_id.name, parent_name_format)
                ...
                sheet.write(row, 5, gross_sale_type_total_budget_current if gross_sale_type_total_budget_current != 0 else '-', sale_type_format)
                ...
                sheet.write(row, 6, gross_sale_type_total_exist_current if gross_sale_type_total_exist_current != 0 else '-', sale_type_format)
                ...
                sheet.write(row, 7, gross_sale_type_total_budget_current1 if gross_sale_type_total_budget_current1 != 0 else '-', sale_type_format)
                ...
                sheet.write(row, 8, gross_sale_type_total_exist_current1 if gross_sale_type_total_exist_current1 != 0 else '-', sale_type_format)
                row += 1
                for sale_type_id in sale_type_ids:
                    sheet.set_row(row, None, None, {'level': 1, 'hidden': True})
                    sheet.write(row, 0, sale_type_id.name, sale_type_name_format)
                    ...
                    for sub_type_id in sale_type_id.mapped('sales_sub_types'):
                        ...
                        sheet.write(row, 5, gross_sub_type_total_budget_current if gross_sub_type_total_budget_current != 0 else '-', bold_2)
                        ...
                        sheet.write(row, 6, gross_sub_type_total_exist_current if gross_sub_type_total_exist_current != 0 else '-', bold_2)
                        ...
                        sheet.write(row, 7, gross_sub_type_total_budget_current1 if gross_sub_type_total_budget_current1 != 0 else '-', bold_2)
                        ...
                        sheet.write(row, 8, gross_sub_type_total_exist_current1 if gross_sub_type_total_exist_current1 != 0 else '-', bold_2)
                        row += 1
